...
public class FatTreeGraph extends Graph {
	 ...
	 */
	private void coreSwitchAddress() {
	 ...
	 */
	private void podSwitchAddress(int numEachPod) {
	 ...
	 * @param numEachPod This is the number of nodes in a pod
	 */
	private void ServerAddress(int numEachPod) {
	...
	private void buildAddress() {
		...
		coreSwitchAddress(); // give addresses for core switches
		podSwitchAddress(numEachPod); // give addresses for pop switches
		ServerAddress(numEachPod); // give addresses for hosts
	}
