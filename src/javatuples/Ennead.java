...
public final class Ennead<A, B, C, D, E, F, G, H, I> extends Tuple implements IValue0<A>, IValue1<B>, IValue2<C>,
	...
	public static <A, B, C, D, E, F, G, H, I> Ennead<A, B, C, D, E, F, G, H, I> with(final A value0, final B value1,
			...
			final I value8) {
		return new Ennead<>(value0, value1, value2, value3, value4, value5, value6, value7,
				value8);
	}
	...
	public static <X> Ennead<X, X, X, X, X, X, X, X, X> fromArray(final X[] array) {
		...
		return new Ennead<>(array[0], array[1], array[2], array[3], array[4], array[5],
	...
	private static <X> Ennead<X, X, X, X, X, X, X, X, X> fromIterable(final Iterable<X> iterable, int index,
		...
		return new Ennead<>(element0, element1, element2, element3, element4, element5,
	...
	public <X0> Decade<X0, A, B, C, D, E, F, G, H, I> addAt0(final X0 value0) {
		return new Decade<>(value0, this.val0, this.val1, this.val2, this.val3, this.val4,
				this.val5, this.val6, this.val7, this.val8);
	}

	public <X0> Decade<A, X0, B, C, D, E, F, G, H, I> addAt1(final X0 value0) {
		return new Decade<>(this.val0, value0, this.val1, this.val2, this.val3, this.val4,
				this.val5, this.val6, this.val7, this.val8);
	}

	public <X0> Decade<A, B, X0, C, D, E, F, G, H, I> addAt2(final X0 value0) {
		return new Decade<>(this.val0, this.val1, value0, this.val2, this.val3, this.val4,
				this.val5, this.val6, this.val7, this.val8);
	}

	public <X0> Decade<A, B, C, X0, D, E, F, G, H, I> addAt3(final X0 value0) {
		return new Decade<>(this.val0, this.val1, this.val2, value0, this.val3, this.val4,
				this.val5, this.val6, this.val7, this.val8);
	}

	public <X0> Decade<A, B, C, D, X0, E, F, G, H, I> addAt4(final X0 value0) {
		return new Decade<>(this.val0, this.val1, this.val2, this.val3, value0, this.val4,
				this.val5, this.val6, this.val7, this.val8);
	}

	public <X0> Decade<A, B, C, D, E, X0, F, G, H, I> addAt5(final X0 value0) {
		return new Decade<>(this.val0, this.val1, this.val2, this.val3, this.val4, value0,
				this.val5, this.val6, this.val7, this.val8);
	}
	...
	public <X> Ennead<X, B, C, D, E, F, G, H, I> setAt0(final X value) {
		return new Ennead<>(value, this.val1, this.val2, this.val3, this.val4, this.val5,
				this.val6, this.val7, this.val8);
	}

	public <X> Ennead<A, X, C, D, E, F, G, H, I> setAt1(final X value) {
		return new Ennead<>(this.val0, value, this.val2, this.val3, this.val4, this.val5,
				this.val6, this.val7, this.val8);
	}

	public <X> Ennead<A, B, X, D, E, F, G, H, I> setAt2(final X value) {
		return new Ennead<>(this.val0, this.val1, value, this.val3, this.val4, this.val5,
				this.val6, this.val7, this.val8);
	}

	public <X> Ennead<A, B, C, X, E, F, G, H, I> setAt3(final X value) {
		return new Ennead<>(this.val0, this.val1, this.val2, value, this.val4, this.val5,
				this.val6, this.val7, this.val8);
	}

	public <X> Ennead<A, B, C, D, X, F, G, H, I> setAt4(final X value) {
		return new Ennead<>(this.val0, this.val1, this.val2, this.val3, value, this.val5,
				this.val6, this.val7, this.val8);
	}

	public <X> Ennead<A, B, C, D, E, X, G, H, I> setAt5(final X value) {
		return new Ennead<>(this.val0, this.val1, this.val2, this.val3, this.val4, value,
				this.val6, this.val7, this.val8);
	}
	...
	public Octet<B, C, D, E, F, G, H, I> removeFrom0() {
		return new Octet<>(this.val1, this.val2, this.val3, this.val4, this.val5, this.val6,
				this.val7, this.val8);
	}

	public Octet<A, C, D, E, F, G, H, I> removeFrom1() {
		return new Octet<>(this.val0, this.val2, this.val3, this.val4, this.val5, this.val6,
				this.val7, this.val8);
	}

	public Octet<A, B, D, E, F, G, H, I> removeFrom2() {
		return new Octet<>(this.val0, this.val1, this.val3, this.val4, this.val5, this.val6,
				this.val7, this.val8);
	}
	...
	public Octet<A, B, C, D, F, G, H, I> removeFrom4() {
		return new Octet<>(this.val0, this.val1, this.val2, this.val3, this.val5, this.val6,
				this.val7, this.val8);
	}

	public Octet<A, B, C, D, E, G, H, I> removeFrom5() {
		return new Octet<>(this.val0, this.val1, this.val2, this.val3, this.val4, this.val6,
				this.val7, this.val8);
	}
