...
public final class Quintet<A, B, C, D, E> extends Tuple
	...
	public static <X> Quintet<X, X, X, X, X> fromArray(final X[] array) {
		...
		if (array.length != 5) {
			throw new IllegalArgumentException(
					"Array must have exactly 5 network.elements in order to create a Quintet. Size is " + array.length);
		}
	...
	/**
	 * <p>
	 * Create tuple from collection. Collection has to have exactly five
	 * network.elements.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Create tuple from iterable. Iterable has to have exactly five
	 * network.elements.
	 * </p>
	 * 
	...
	private static <X> Quintet<X, X, X, X, X> fromIterable(final Iterable<X> iterable, int index,
		...
		if (iter.hasNext() && exactSize) {
			throw new IllegalArgumentException(
					"Iterable must have exactly 5 available network.elements in order to create a Quintet.");
		}
	...
	public <X0> Sextet<X0, A, B, C, D, E> addAt0(final X0 value0) {
		return new Sextet<X0, A, B, C, D, E>(value0, this.val0, this.val1, this.val2, this.val3, this.val4);
	}

	public <X0> Sextet<A, X0, B, C, D, E> addAt1(final X0 value0) {
		return new Sextet<A, X0, B, C, D, E>(this.val0, value0, this.val1, this.val2, this.val3, this.val4);
	}

	public <X0> Sextet<A, B, X0, C, D, E> addAt2(final X0 value0) {
		return new Sextet<A, B, X0, C, D, E>(this.val0, this.val1, value0, this.val2, this.val3, this.val4);
	}

	public <X0> Sextet<A, B, C, X0, D, E> addAt3(final X0 value0) {
		return new Sextet<A, B, C, X0, D, E>(this.val0, this.val1, this.val2, value0, this.val3, this.val4);
	}

	public <X0> Sextet<A, B, C, D, X0, E> addAt4(final X0 value0) {
		return new Sextet<A, B, C, D, X0, E>(this.val0, this.val1, this.val2, this.val3, value0, this.val4);
	}

	public <X0> Sextet<A, B, C, D, E, X0> addAt5(final X0 value0) {
		return new Sextet<A, B, C, D, E, X0>(this.val0, this.val1, this.val2, this.val3, this.val4, value0);
	}

	public <X0, X1> Septet<X0, X1, A, B, C, D, E> addAt0(final X0 value0, final X1 value1) {
		return new Septet<X0, X1, A, B, C, D, E>(value0, value1, this.val0, this.val1, this.val2, this.val3, this.val4);
	}

	public <X0, X1> Septet<A, X0, X1, B, C, D, E> addAt1(final X0 value0, final X1 value1) {
		return new Septet<A, X0, X1, B, C, D, E>(this.val0, value0, value1, this.val1, this.val2, this.val3, this.val4);
	}

	public <X0, X1> Septet<A, B, X0, X1, C, D, E> addAt2(final X0 value0, final X1 value1) {
		return new Septet<A, B, X0, X1, C, D, E>(this.val0, this.val1, value0, value1, this.val2, this.val3, this.val4);
	}

	public <X0, X1> Septet<A, B, C, X0, X1, D, E> addAt3(final X0 value0, final X1 value1) {
		return new Septet<A, B, C, X0, X1, D, E>(this.val0, this.val1, this.val2, value0, value1, this.val3, this.val4);
	}

	public <X0, X1> Septet<A, B, C, D, X0, X1, E> addAt4(final X0 value0, final X1 value1) {
		return new Septet<A, B, C, D, X0, X1, E>(this.val0, this.val1, this.val2, this.val3, value0, value1, this.val4);
	}

	public <X0, X1> Septet<A, B, C, D, E, X0, X1> addAt5(final X0 value0, final X1 value1) {
		return new Septet<A, B, C, D, E, X0, X1>(this.val0, this.val1, this.val2, this.val3, this.val4, value0, value1);
	}

	public <X0, X1, X2> Octet<X0, X1, X2, A, B, C, D, E> addAt0(final X0 value0, final X1 value1, final X2 value2) {
		return new Octet<X0, X1, X2, A, B, C, D, E>(value0, value1, value2, this.val0, this.val1, this.val2, this.val3,
				this.val4);
	}

	public <X0, X1, X2> Octet<A, X0, X1, X2, B, C, D, E> addAt1(final X0 value0, final X1 value1, final X2 value2) {
		return new Octet<A, X0, X1, X2, B, C, D, E>(this.val0, value0, value1, value2, this.val1, this.val2, this.val3,
				this.val4);
	}

	public <X0, X1, X2> Octet<A, B, X0, X1, X2, C, D, E> addAt2(final X0 value0, final X1 value1, final X2 value2) {
		return new Octet<A, B, X0, X1, X2, C, D, E>(this.val0, this.val1, value0, value1, value2, this.val2, this.val3,
				this.val4);
	}

	public <X0, X1, X2> Octet<A, B, C, X0, X1, X2, D, E> addAt3(final X0 value0, final X1 value1, final X2 value2) {
		return new Octet<A, B, C, X0, X1, X2, D, E>(this.val0, this.val1, this.val2, value0, value1, value2, this.val3,
				this.val4);
	}

	public <X0, X1, X2> Octet<A, B, C, D, X0, X1, X2, E> addAt4(final X0 value0, final X1 value1, final X2 value2) {
		return new Octet<A, B, C, D, X0, X1, X2, E>(this.val0, this.val1, this.val2, this.val3, value0, value1, value2,
				this.val4);
	}

	public <X0, X1, X2> Octet<A, B, C, D, E, X0, X1, X2> addAt5(final X0 value0, final X1 value1, final X2 value2) {
		return new Octet<A, B, C, D, E, X0, X1, X2>(this.val0, this.val1, this.val2, this.val3, this.val4, value0,
				value1, value2);
	}

	public <X0, X1, X2, X3> Ennead<X0, X1, X2, X3, A, B, C, D, E> addAt0(final X0 value0, final X1 value1,
			final X2 value2, final X3 value3) {
		return new Ennead<X0, X1, X2, X3, A, B, C, D, E>(value0, value1, value2, value3, this.val0, this.val1,
				this.val2, this.val3, this.val4);
	}

	public <X0, X1, X2, X3> Ennead<A, X0, X1, X2, X3, B, C, D, E> addAt1(final X0 value0, final X1 value1,
			final X2 value2, final X3 value3) {
		return new Ennead<A, X0, X1, X2, X3, B, C, D, E>(this.val0, value0, value1, value2, value3, this.val1,
				this.val2, this.val3, this.val4);
	}

	public <X0, X1, X2, X3> Ennead<A, B, X0, X1, X2, X3, C, D, E> addAt2(final X0 value0, final X1 value1,
			final X2 value2, final X3 value3) {
		return new Ennead<A, B, X0, X1, X2, X3, C, D, E>(this.val0, this.val1, value0, value1, value2, value3,
				this.val2, this.val3, this.val4);
	}

	public <X0, X1, X2, X3> Ennead<A, B, C, X0, X1, X2, X3, D, E> addAt3(final X0 value0, final X1 value1,
			final X2 value2, final X3 value3) {
		return new Ennead<A, B, C, X0, X1, X2, X3, D, E>(this.val0, this.val1, this.val2, value0, value1, value2,
				value3, this.val3, this.val4);
	}

	public <X0, X1, X2, X3> Ennead<A, B, C, D, X0, X1, X2, X3, E> addAt4(final X0 value0, final X1 value1,
			final X2 value2, final X3 value3) {
		return new Ennead<A, B, C, D, X0, X1, X2, X3, E>(this.val0, this.val1, this.val2, this.val3, value0, value1,
				value2, value3, this.val4);
	}
	...
	public <X0, X1, X2, X3, X4> Decade<X0, X1, X2, X3, X4, A, B, C, D, E> addAt0(final X0 value0, final X1 value1,
			final X2 value2, final X3 value3, final X4 value4) {
		return new Decade<X0, X1, X2, X3, X4, A, B, C, D, E>(value0, value1, value2, value3, value4, this.val0,
				this.val1, this.val2, this.val3, this.val4);
	}

	public <X0, X1, X2, X3, X4> Decade<A, X0, X1, X2, X3, X4, B, C, D, E> addAt1(final X0 value0, final X1 value1,
			final X2 value2, final X3 value3, final X4 value4) {
		return new Decade<A, X0, X1, X2, X3, X4, B, C, D, E>(this.val0, value0, value1, value2, value3, value4,
				this.val1, this.val2, this.val3, this.val4);
	}

	public <X0, X1, X2, X3, X4> Decade<A, B, X0, X1, X2, X3, X4, C, D, E> addAt2(final X0 value0, final X1 value1,
			final X2 value2, final X3 value3, final X4 value4) {
		return new Decade<A, B, X0, X1, X2, X3, X4, C, D, E>(this.val0, this.val1, value0, value1, value2, value3,
				value4, this.val2, this.val3, this.val4);
	}

	public <X0, X1, X2, X3, X4> Decade<A, B, C, X0, X1, X2, X3, X4, D, E> addAt3(final X0 value0, final X1 value1,
			final X2 value2, final X3 value3, final X4 value4) {
		return new Decade<A, B, C, X0, X1, X2, X3, X4, D, E>(this.val0, this.val1, this.val2, value0, value1, value2,
				value3, value4, this.val3, this.val4);
	}

	public <X0, X1, X2, X3, X4> Decade<A, B, C, D, X0, X1, X2, X3, X4, E> addAt4(final X0 value0, final X1 value1,
			final X2 value2, final X3 value3, final X4 value4) {
		return new Decade<A, B, C, D, X0, X1, X2, X3, X4, E>(this.val0, this.val1, this.val2, this.val3, value0, value1,
				value2, value3, value4, this.val4);
	}

	public <X0, X1, X2, X3, X4> Decade<A, B, C, D, E, X0, X1, X2, X3, X4> addAt5(final X0 value0, final X1 value1,
			final X2 value2, final X3 value3, final X4 value4) {
		return new Decade<A, B, C, D, E, X0, X1, X2, X3, X4>(this.val0, this.val1, this.val2, this.val3, this.val4,
	...
	public <X0, X1, X2, X3> Ennead<A, B, C, D, E, X0, X1, X2, X3> add(final X0 value0, final X1 value1, final X2 value2,
			final X3 value3) {
	...
	public <X0, X1, X2, X3, X4> Decade<A, B, C, D, E, X0, X1, X2, X3, X4> add(final X0 value0, final X1 value1,
			final X2 value2, final X3 value3, final X4 value4) {
