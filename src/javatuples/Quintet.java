...
public final class Quintet<A, B, C, D, E> extends Tuple
	...
	public <X0> Sextet<X0, A, B, C, D, E> addAt0(final X0 value0) {
		return new Sextet<>(value0, this.val0, this.val1, this.val2, this.val3, this.val4);
	}

	public <X0> Sextet<A, X0, B, C, D, E> addAt1(final X0 value0) {
		return new Sextet<>(this.val0, value0, this.val1, this.val2, this.val3, this.val4);
	}

	public <X0> Sextet<A, B, X0, C, D, E> addAt2(final X0 value0) {
		return new Sextet<>(this.val0, this.val1, value0, this.val2, this.val3, this.val4);
	}

	public <X0> Sextet<A, B, C, X0, D, E> addAt3(final X0 value0) {
		return new Sextet<>(this.val0, this.val1, this.val2, value0, this.val3, this.val4);
	}

	public <X0> Sextet<A, B, C, D, X0, E> addAt4(final X0 value0) {
		return new Sextet<>(this.val0, this.val1, this.val2, this.val3, value0, this.val4);
	}

	public <X0> Sextet<A, B, C, D, E, X0> addAt5(final X0 value0) {
		return new Sextet<>(this.val0, this.val1, this.val2, this.val3, this.val4, value0);
	}

	public <X0, X1> Septet<X0, X1, A, B, C, D, E> addAt0(final X0 value0, final X1 value1) {
		return new Septet<>(value0, value1, this.val0, this.val1, this.val2, this.val3, this.val4);
	}

	public <X0, X1> Septet<A, X0, X1, B, C, D, E> addAt1(final X0 value0, final X1 value1) {
		return new Septet<>(this.val0, value0, value1, this.val1, this.val2, this.val3, this.val4);
	}

	public <X0, X1> Septet<A, B, X0, X1, C, D, E> addAt2(final X0 value0, final X1 value1) {
		return new Septet<>(this.val0, this.val1, value0, value1, this.val2, this.val3, this.val4);
	}

	public <X0, X1> Septet<A, B, C, X0, X1, D, E> addAt3(final X0 value0, final X1 value1) {
		return new Septet<>(this.val0, this.val1, this.val2, value0, value1, this.val3, this.val4);
	}

	public <X0, X1> Septet<A, B, C, D, X0, X1, E> addAt4(final X0 value0, final X1 value1) {
		return new Septet<>(this.val0, this.val1, this.val2, this.val3, value0, value1, this.val4);
	}

	public <X0, X1> Septet<A, B, C, D, E, X0, X1> addAt5(final X0 value0, final X1 value1) {
		return new Septet<>(this.val0, this.val1, this.val2, this.val3, this.val4, value0, value1);
	}

	public <X0, X1, X2> Octet<X0, X1, X2, A, B, C, D, E> addAt0(final X0 value0, final X1 value1, final X2 value2) {
		return new Octet<>(value0, value1, value2, this.val0, this.val1, this.val2, this.val3,
				this.val4);
	}

	public <X0, X1, X2> Octet<A, X0, X1, X2, B, C, D, E> addAt1(final X0 value0, final X1 value1, final X2 value2) {
		return new Octet<>(this.val0, value0, value1, value2, this.val1, this.val2, this.val3,
				this.val4);
	}

	public <X0, X1, X2> Octet<A, B, X0, X1, X2, C, D, E> addAt2(final X0 value0, final X1 value1, final X2 value2) {
		return new Octet<>(this.val0, this.val1, value0, value1, value2, this.val2, this.val3,
				this.val4);
	}

	public <X0, X1, X2> Octet<A, B, C, X0, X1, X2, D, E> addAt3(final X0 value0, final X1 value1, final X2 value2) {
		return new Octet<>(this.val0, this.val1, this.val2, value0, value1, value2, this.val3,
				this.val4);
	}
	...
	public <X0, X1, X2, X3, X4> Decade<X0, X1, X2, X3, X4, A, B, C, D, E> addAt0(final X0 value0, final X1 value1,
		...
		return new Decade<>(value0, value1, value2, value3, value4, this.val0,
	...
	public <X0, X1, X2, X3, X4> Decade<A, B, C, D, X0, X1, X2, X3, X4, E> addAt4(final X0 value0, final X1 value1,
			final X2 value2, final X3 value3, final X4 value4) {
		return new Decade<>(this.val0, this.val1, this.val2, this.val3, value0, value1,
	...
	public <X> Quintet<X, B, C, D, E> setAt0(final X value) {
		return new Quintet<>(value, this.val1, this.val2, this.val3, this.val4);
	}

	public <X> Quintet<A, X, C, D, E> setAt1(final X value) {
		return new Quintet<>(this.val0, value, this.val2, this.val3, this.val4);
	}

	public <X> Quintet<A, B, X, D, E> setAt2(final X value) {
		return new Quintet<>(this.val0, this.val1, value, this.val3, this.val4);
	}

	public <X> Quintet<A, B, C, X, E> setAt3(final X value) {
		return new Quintet<>(this.val0, this.val1, this.val2, value, this.val4);
	}

	public <X> Quintet<A, B, C, D, X> setAt4(final X value) {
		return new Quintet<>(this.val0, this.val1, this.val2, this.val3, value);
	}

	public Quartet<B, C, D, E> removeFrom0() {
		return new Quartet<>(this.val1, this.val2, this.val3, this.val4);
	}

	public Quartet<A, C, D, E> removeFrom1() {
		return new Quartet<>(this.val0, this.val2, this.val3, this.val4);
	}

	public Quartet<A, B, D, E> removeFrom2() {
		return new Quartet<>(this.val0, this.val1, this.val3, this.val4);
	}

	public Quartet<A, B, C, E> removeFrom3() {
		return new Quartet<>(this.val0, this.val1, this.val2, this.val4);
	}

	public Quartet<A, B, C, D> removeFrom4() {
		return new Quartet<>(this.val0, this.val1, this.val2, this.val3);
	}
}
