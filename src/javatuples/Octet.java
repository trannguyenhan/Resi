...
public final class Octet<A, B, C, D, E, F, G, H> extends Tuple
	...
	public static <X> Octet<X, X, X, X, X, X, X, X> fromArray(final X[] array) {
		...
		return new Octet<>(array[0], array[1], array[2], array[3], array[4], array[5], array[6],
				array[7]);
	}
	...
	private static <X> Octet<X, X, X, X, X, X, X, X> fromIterable(final Iterable<X> iterable, int index,
		...
		return new Octet<>(element0, element1, element2, element3, element4, element5, element6,
				element7);
	...
	public <X0> Ennead<X0, A, B, C, D, E, F, G, H> addAt0(final X0 value0) {
		return new Ennead<>(value0, this.val0, this.val1, this.val2, this.val3, this.val4,
				this.val5, this.val6, this.val7);
	}

	public <X0> Ennead<A, X0, B, C, D, E, F, G, H> addAt1(final X0 value0) {
		return new Ennead<>(this.val0, value0, this.val1, this.val2, this.val3, this.val4,
				this.val5, this.val6, this.val7);
	}

	public <X0> Ennead<A, B, X0, C, D, E, F, G, H> addAt2(final X0 value0) {
		return new Ennead<>(this.val0, this.val1, value0, this.val2, this.val3, this.val4,
				this.val5, this.val6, this.val7);
	}

	public <X0> Ennead<A, B, C, X0, D, E, F, G, H> addAt3(final X0 value0) {
		return new Ennead<>(this.val0, this.val1, this.val2, value0, this.val3, this.val4,
				this.val5, this.val6, this.val7);
	}

	public <X0> Ennead<A, B, C, D, X0, E, F, G, H> addAt4(final X0 value0) {
		return new Ennead<>(this.val0, this.val1, this.val2, this.val3, value0, this.val4,
				this.val5, this.val6, this.val7);
	}
	...
	public <X0, X1> Decade<X0, X1, A, B, C, D, E, F, G, H> addAt0(final X0 value0, final X1 value1) {
		return new Decade<>(value0, value1, this.val0, this.val1, this.val2, this.val3,
				this.val4, this.val5, this.val6, this.val7);
	}

	public <X0, X1> Decade<A, X0, X1, B, C, D, E, F, G, H> addAt1(final X0 value0, final X1 value1) {
		return new Decade<>(this.val0, value0, value1, this.val1, this.val2, this.val3,
				this.val4, this.val5, this.val6, this.val7);
	}

	public <X0, X1> Decade<A, B, X0, X1, C, D, E, F, G, H> addAt2(final X0 value0, final X1 value1) {
		return new Decade<>(this.val0, this.val1, value0, value1, this.val2, this.val3,
				this.val4, this.val5, this.val6, this.val7);
	}

	public <X0, X1> Decade<A, B, C, X0, X1, D, E, F, G, H> addAt3(final X0 value0, final X1 value1) {
		return new Decade<>(this.val0, this.val1, this.val2, value0, value1, this.val3,
				this.val4, this.val5, this.val6, this.val7);
	}
	...
	public <X> Octet<X, B, C, D, E, F, G, H> setAt0(final X value) {
		return new Octet<>(value, this.val1, this.val2, this.val3, this.val4, this.val5,
				this.val6, this.val7);
	}

	public <X> Octet<A, X, C, D, E, F, G, H> setAt1(final X value) {
		return new Octet<>(this.val0, value, this.val2, this.val3, this.val4, this.val5,
				this.val6, this.val7);
	}

	public <X> Octet<A, B, X, D, E, F, G, H> setAt2(final X value) {
		return new Octet<>(this.val0, this.val1, value, this.val3, this.val4, this.val5,
				this.val6, this.val7);
	}

	public <X> Octet<A, B, C, X, E, F, G, H> setAt3(final X value) {
		return new Octet<>(this.val0, this.val1, this.val2, value, this.val4, this.val5,
				this.val6, this.val7);
	}

	public <X> Octet<A, B, C, D, X, F, G, H> setAt4(final X value) {
		return new Octet<>(this.val0, this.val1, this.val2, this.val3, value, this.val5,
				this.val6, this.val7);
	}

	public <X> Octet<A, B, C, D, E, X, G, H> setAt5(final X value) {
		return new Octet<>(this.val0, this.val1, this.val2, this.val3, this.val4, value,
				this.val6, this.val7);
	}
	...
	public Septet<B, C, D, E, F, G, H> removeFrom0() {
		return new Septet<>(this.val1, this.val2, this.val3, this.val4, this.val5, this.val6,
				this.val7);
	}

	public Septet<A, C, D, E, F, G, H> removeFrom1() {
		return new Septet<>(this.val0, this.val2, this.val3, this.val4, this.val5, this.val6,
				this.val7);
	}

	public Septet<A, B, D, E, F, G, H> removeFrom2() {
		return new Septet<>(this.val0, this.val1, this.val3, this.val4, this.val5, this.val6,
				this.val7);
	}

	public Septet<A, B, C, E, F, G, H> removeFrom3() {
		return new Septet<>(this.val0, this.val1, this.val2, this.val4, this.val5, this.val6,
				this.val7);
	}

	public Septet<A, B, C, D, F, G, H> removeFrom4() {
		return new Septet<>(this.val0, this.val1, this.val2, this.val3, this.val5, this.val6,
				this.val7);
	}

	public Septet<A, B, C, D, E, G, H> removeFrom5() {
		return new Septet<>(this.val0, this.val1, this.val2, this.val3, this.val4, this.val6,
				this.val7);
	}
