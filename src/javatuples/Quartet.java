...
public final class Quartet<A, B, C, D> extends Tuple implements IValue0<A>, IValue1<B>, IValue2<C>, IValue3<D> {
	...
	public static <A, B, C, D> Quartet<A, B, C, D> with(final A value0, final B value1, final C value2,
			final D value3) {
	...
	public static <X> Quartet<X, X, X, X> fromArray(final X[] array) {
		...
		if (array.length != 4) {
			throw new IllegalArgumentException(
					"Array must have exactly 4 network.elements in order to create a Quartet. Size is " + array.length);
		}
	...
	/**
	 * <p>
	 * Create tuple from collection. Collection has to have exactly four
	 * network.elements.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Create tuple from iterable. Iterable has to have exactly four
	 * network.elements.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Create tuple from iterable, starting from the specified index. Iterable can
	 * have more (or less) network.elements than the tuple to be created.
	 * </p>
	 * 
	 * @param <X>      the iterable component type
	 * @param iterable the iterable to be converted to a tuple
	...
	private static <X> Quartet<X, X, X, X> fromIterable(final Iterable<X> iterable, int index,
		...
		if (iter.hasNext() && exactSize) {
			throw new IllegalArgumentException(
					"Iterable must have exactly 4 available network.elements in order to create a Quartet.");
		}
	...
	public <X0> Quintet<X0, A, B, C, D> addAt0(final X0 value0) {
		return new Quintet<>(value0, this.val0, this.val1, this.val2, this.val3);
	}

	public <X0> Quintet<A, X0, B, C, D> addAt1(final X0 value0) {
		return new Quintet<>(this.val0, value0, this.val1, this.val2, this.val3);
	}

	public <X0> Quintet<A, B, X0, C, D> addAt2(final X0 value0) {
		return new Quintet<>(this.val0, this.val1, value0, this.val2, this.val3);
	}

	public <X0> Quintet<A, B, C, X0, D> addAt3(final X0 value0) {
		return new Quintet<>(this.val0, this.val1, this.val2, value0, this.val3);
	}

	public <X0> Quintet<A, B, C, D, X0> addAt4(final X0 value0) {
		return new Quintet<>(this.val0, this.val1, this.val2, this.val3, value0);
	}

	public <X0, X1> Sextet<X0, X1, A, B, C, D> addAt0(final X0 value0, final X1 value1) {
		return new Sextet<>(value0, value1, this.val0, this.val1, this.val2, this.val3);
	}

	public <X0, X1> Sextet<A, X0, X1, B, C, D> addAt1(final X0 value0, final X1 value1) {
		return new Sextet<>(this.val0, value0, value1, this.val1, this.val2, this.val3);
	}

	public <X0, X1> Sextet<A, B, X0, X1, C, D> addAt2(final X0 value0, final X1 value1) {
		return new Sextet<>(this.val0, this.val1, value0, value1, this.val2, this.val3);
	}

	public <X0, X1> Sextet<A, B, C, X0, X1, D> addAt3(final X0 value0, final X1 value1) {
		return new Sextet<>(this.val0, this.val1, this.val2, value0, value1, this.val3);
	}

	public <X0, X1> Sextet<A, B, C, D, X0, X1> addAt4(final X0 value0, final X1 value1) {
		return new Sextet<>(this.val0, this.val1, this.val2, this.val3, value0, value1);
	}

	public <X0, X1, X2> Septet<X0, X1, X2, A, B, C, D> addAt0(final X0 value0, final X1 value1, final X2 value2) {
		return new Septet<>(value0, value1, value2, this.val0, this.val1, this.val2, this.val3);
	}

	public <X0, X1, X2> Septet<A, X0, X1, X2, B, C, D> addAt1(final X0 value0, final X1 value1, final X2 value2) {
		return new Septet<>(this.val0, value0, value1, value2, this.val1, this.val2, this.val3);
	}

	public <X0, X1, X2> Septet<A, B, X0, X1, X2, C, D> addAt2(final X0 value0, final X1 value1, final X2 value2) {
		return new Septet<>(this.val0, this.val1, value0, value1, value2, this.val2, this.val3);
	}

	public <X0, X1, X2> Septet<A, B, C, X0, X1, X2, D> addAt3(final X0 value0, final X1 value1, final X2 value2) {
		return new Septet<>(this.val0, this.val1, this.val2, value0, value1, value2, this.val3);
	}

	public <X0, X1, X2> Septet<A, B, C, D, X0, X1, X2> addAt4(final X0 value0, final X1 value1, final X2 value2) {
		return new Septet<>(this.val0, this.val1, this.val2, this.val3, value0, value1, value2);
	}

	public <X0, X1, X2, X3> Octet<X0, X1, X2, X3, A, B, C, D> addAt0(final X0 value0, final X1 value1, final X2 value2,
			final X3 value3) {
		return new Octet<>(value0, value1, value2, value3, this.val0, this.val1, this.val2,
				this.val3);
	}

	public <X0, X1, X2, X3> Octet<A, X0, X1, X2, X3, B, C, D> addAt1(final X0 value0, final X1 value1, final X2 value2,
			final X3 value3) {
		return new Octet<>(this.val0, value0, value1, value2, value3, this.val1, this.val2,
				this.val3);
	}

	public <X0, X1, X2, X3> Octet<A, B, X0, X1, X2, X3, C, D> addAt2(final X0 value0, final X1 value1, final X2 value2,
			final X3 value3) {
		return new Octet<>(this.val0, this.val1, value0, value1, value2, value3, this.val2,
				this.val3);
	}

	public <X0, X1, X2, X3> Octet<A, B, C, X0, X1, X2, X3, D> addAt3(final X0 value0, final X1 value1, final X2 value2,
			final X3 value3) {
		return new Octet<>(this.val0, this.val1, this.val2, value0, value1, value2, value3,
				this.val3);
	}

	public <X0, X1, X2, X3> Octet<A, B, C, D, X0, X1, X2, X3> addAt4(final X0 value0, final X1 value1, final X2 value2,
			final X3 value3) {
		return new Octet<>(this.val0, this.val1, this.val2, this.val3, value0, value1, value2,
				value3);
	}

	public <X0, X1, X2, X3, X4> Ennead<X0, X1, X2, X3, X4, A, B, C, D> addAt0(final X0 value0, final X1 value1,
			final X2 value2, final X3 value3, final X4 value4) {
		return new Ennead<>(value0, value1, value2, value3, value4, this.val0, this.val1,
				this.val2, this.val3);
	}

	public <X0, X1, X2, X3, X4> Ennead<A, X0, X1, X2, X3, X4, B, C, D> addAt1(final X0 value0, final X1 value1,
			final X2 value2, final X3 value3, final X4 value4) {
		return new Ennead<>(this.val0, value0, value1, value2, value3, value4, this.val1,
				this.val2, this.val3);
	}

	public <X0, X1, X2, X3, X4> Ennead<A, B, X0, X1, X2, X3, X4, C, D> addAt2(final X0 value0, final X1 value1,
			final X2 value2, final X3 value3, final X4 value4) {
		return new Ennead<>(this.val0, this.val1, value0, value1, value2, value3, value4,
				this.val2, this.val3);
	}

	public <X0, X1, X2, X3, X4> Ennead<A, B, C, X0, X1, X2, X3, X4, D> addAt3(final X0 value0, final X1 value1,
			final X2 value2, final X3 value3, final X4 value4) {
		return new Ennead<>(this.val0, this.val1, this.val2, value0, value1, value2,
				value3, value4, this.val3);
	}

	public <X0, X1, X2, X3, X4> Ennead<A, B, C, D, X0, X1, X2, X3, X4> addAt4(final X0 value0, final X1 value1,
			final X2 value2, final X3 value3, final X4 value4) {
		return new Ennead<>(this.val0, this.val1, this.val2, this.val3, value0, value1,
				value2, value3, value4);
	}

	public <X0, X1, X2, X3, X4, X5> Decade<X0, X1, X2, X3, X4, X5, A, B, C, D> addAt0(final X0 value0, final X1 value1,
			final X2 value2, final X3 value3, final X4 value4, final X5 value5) {
		return new Decade<>(value0, value1, value2, value3, value4, value5, this.val0,
				this.val1, this.val2, this.val3);
	}

	public <X0, X1, X2, X3, X4, X5> Decade<A, X0, X1, X2, X3, X4, X5, B, C, D> addAt1(final X0 value0, final X1 value1,
			final X2 value2, final X3 value3, final X4 value4, final X5 value5) {
		return new Decade<>(this.val0, value0, value1, value2, value3, value4, value5,
				this.val1, this.val2, this.val3);
	}

	public <X0, X1, X2, X3, X4, X5> Decade<A, B, X0, X1, X2, X3, X4, X5, C, D> addAt2(final X0 value0, final X1 value1,
			final X2 value2, final X3 value3, final X4 value4, final X5 value5) {
		return new Decade<>(this.val0, this.val1, value0, value1, value2, value3,
				value4, value5, this.val2, this.val3);
	}

	public <X0, X1, X2, X3, X4, X5> Decade<A, B, C, X0, X1, X2, X3, X4, X5, D> addAt3(final X0 value0, final X1 value1,
			final X2 value2, final X3 value3, final X4 value4, final X5 value5) {
		return new Decade<>(this.val0, this.val1, this.val2, value0, value1, value2,
				value3, value4, value5, this.val3);
	}

	public <X0, X1, X2, X3, X4, X5> Decade<A, B, C, D, X0, X1, X2, X3, X4, X5> addAt4(final X0 value0, final X1 value1,
			final X2 value2, final X3 value3, final X4 value4, final X5 value5) {
		return new Decade<>(this.val0, this.val1, this.val2, this.val3, value0,
	...
	public <X0, X1, X2, X3, X4, X5> Decade<X0, X1, X2, X3, X4, X5, A, B, C, D> addAt0(
			final Sextet<X0, X1, X2, X3, X4, X5> tuple) {
		return addAt0(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3(), tuple.getValue4(),
				tuple.getValue5());
	}

	public <X0, X1, X2, X3, X4, X5> Decade<A, X0, X1, X2, X3, X4, X5, B, C, D> addAt1(
			final Sextet<X0, X1, X2, X3, X4, X5> tuple) {
		return addAt1(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3(), tuple.getValue4(),
				tuple.getValue5());
	}

	public <X0, X1, X2, X3, X4, X5> Decade<A, B, X0, X1, X2, X3, X4, X5, C, D> addAt2(
			final Sextet<X0, X1, X2, X3, X4, X5> tuple) {
		return addAt2(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3(), tuple.getValue4(),
				tuple.getValue5());
	}

	public <X0, X1, X2, X3, X4, X5> Decade<A, B, C, X0, X1, X2, X3, X4, X5, D> addAt3(
			final Sextet<X0, X1, X2, X3, X4, X5> tuple) {
		return addAt3(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3(), tuple.getValue4(),
				tuple.getValue5());
	}

	public <X0, X1, X2, X3, X4, X5> Decade<A, B, C, D, X0, X1, X2, X3, X4, X5> addAt4(
			final Sextet<X0, X1, X2, X3, X4, X5> tuple) {
		return addAt4(tuple.getValue0(), tuple.getValue1(), tuple.getValue2(), tuple.getValue3(), tuple.getValue4(),
				tuple.getValue5());
	}
	...
	public <X0, X1, X2, X3> Octet<A, B, C, D, X0, X1, X2, X3> add(final X0 value0, final X1 value1, final X2 value2,
			final X3 value3) {
	...
	public <X0, X1, X2, X3, X4> Ennead<A, B, C, D, X0, X1, X2, X3, X4> add(final X0 value0, final X1 value1,
			final X2 value2, final X3 value3, final X4 value4) {
	...
	public <X0, X1, X2, X3, X4, X5> Decade<A, B, C, D, X0, X1, X2, X3, X4, X5> add(final X0 value0, final X1 value1,
			final X2 value2, final X3 value3, final X4 value4, final X5 value5) {
		return addAt4(value0, value1, value2, value3, value4, value5);
	}

	public <X0, X1, X2, X3, X4, X5> Decade<A, B, C, D, X0, X1, X2, X3, X4, X5> add(
			final Sextet<X0, X1, X2, X3, X4, X5> tuple) {
		return addAt4(tuple);
	}

	public <X> Quartet<X, B, C, D> setAt0(final X value) {
		return new Quartet<>(value, this.val1, this.val2, this.val3);
	}

	public <X> Quartet<A, X, C, D> setAt1(final X value) {
		return new Quartet<>(this.val0, value, this.val2, this.val3);
	}

	public <X> Quartet<A, B, X, D> setAt2(final X value) {
		return new Quartet<>(this.val0, this.val1, value, this.val3);
	}

	public <X> Quartet<A, B, C, X> setAt3(final X value) {
		return new Quartet<>(this.val0, this.val1, this.val2, value);
	}

	public Triplet<B, C, D> removeFrom0() {
		return new Triplet<>(this.val1, this.val2, this.val3);
	}

	public Triplet<A, C, D> removeFrom1() {
		return new Triplet<>(this.val0, this.val2, this.val3);
	}

	public Triplet<A, B, D> removeFrom2() {
		return new Triplet<>(this.val0, this.val1, this.val3);
	}

	public Triplet<A, B, C> removeFrom3() {
		return new Triplet<>(this.val0, this.val1, this.val2);
	}
}
