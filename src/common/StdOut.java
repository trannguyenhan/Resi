 ...
 * Otherwise, download <a href =
 * "http://introcs.cs.princeton.edu/java/stdlib/StdOut.java">StdOut.java</a> and
 ...
 * to that of {@link System#out}, but there are a few subtle differences:
 * <ul>
...
public final class StdOut {
	...
	public static void printProgress(String processName, long startTime, long total, long current) {
		...
		string.append('\r').append(String.format("%s: ", processName))
				.append(String.join("", Collections.nCopies(percent == 0 ? 2 : 2 - (int) (Math.log10(percent)), " ")))
				.append(String.format(" %d%% [", percent))
				.append(String.join("", Collections.nCopies(percent / 4, "="))).append('>')
				.append(String.join("", Collections.nCopies(100 / 4 - percent / 4, " "))).append(']')
				.append(String.join("",
