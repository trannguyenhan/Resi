 ...
 * the same program.
 * <p>
 * <b>Reading tokens from standard input one at a time, and converting to
 * numbers and strings.</b> You can use the following methods to read numbers,
 ...
 * </ul>
 * <p>
 * Each method skips over any input that is whitespace. Then, it reads the next
 * token and attempts to convert it into a value of the specified type. If it
 * succeeds, it returns that value; otherwise, it throws a
 ...
 * <p>
 * <b>Reading characters from standard input, one at a time.</b> You can use the
 * following two methods to read characters from standard input:
 * <ul>
 * <li>{@link #hasNextChar()}
 * <li>{@link #readChar()}
 * </ul>
 ...
 * </pre>
 * <p>
 * <b>Reading lines from standard input, one at a time.</b> You can use the
 * following two methods to read lines from standard input:
 * <ul>
 * <li>{@link #hasNextLine()}
 * <li>{@link #readLine()}
 * </ul>
 ...
 * designed to parse tokens and convert them to primitive types and strings.
 ...
 * <li>{@code StdIn} coerces the character-set encoding to UTF-8, which is a
 ...
 * was introduced, this class was reimplemented to use {@code Scanner}.
 * <p>
 ...
 * {@code StdIn} will have an extra character {@code &#92;uFEFF} at the
 * beginning.
 * <p>
